                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card card-primary">
                                                            <div class="card-header">
                                                                <span>Phonepe</span>
                                                                <label class="cl-switch cl-switch-blue float-right">
                                                                    <input type="checkbox" id="phonepe_enable" value="1" name="name[phonepe_enable]" @if(App\Models\PaymentSetting::getPaymentSetting('phonepe_enable')==1) checked @endif>
                                                                    <span class="switcher"></span>
                                                                </label>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="form-group">
                                                                    <label for="phonepe_merchant_id">Phonepe Merchant Id</label>
                                                                    <input type="text" class="form-control" name="name[phonepe_merchant_id]" id="phonepe_merchant_id" value="{{App\Models\PaymentSetting::getPaymentSetting('phonepe_merchant_id')}}" placeholder="Enter Phonepe Merchant Id">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="phonepe_salt_key">Phonepe Salt Key</label>
                                                                    <input type="text" class="form-control" name="name[phonepe_salt_key]" id="phonepe_salt_key" value="{{App\Models\PaymentSetting::getPaymentSetting('phonepe_salt_key')}}" placeholder="Enter Phonepe Salt Key">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="collapse61" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6 col-9 mt-1">
                                                                <label class="cl-switch cl-switch-blue">
                                                                    <input type="checkbox" id="whatsapp_auth_enable" value="1" name="name[whatsapp_auth_enable]" @if(App\Models\WhatsAppSetting::getWhatsAppSetting('whatsapp_auth_enable')==1) checked @endif>
                                                                    <span class="switcher"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <label for="example-text-input" class="col-md-3 col-3 col-form-label">Send OTP Message</label>
                                                            <div class="col-md-6 col-9 mt-1">
                                                                <textarea class="form-control" name="name[whatsapp_otp_message]" type="text" placeholder="Enter Send OTP message" rows=3 required>{{App\Models\WhatsAppSetting::getWhatsAppSetting('whatsapp_otp_message')}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
